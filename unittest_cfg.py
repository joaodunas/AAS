...
class TestCfg(unittest.TestCase):
    ...
    #def test_p4(self):
        ##((1, 2, 3, 4, 5, 4, 6, 7), 8, 7, 9, 11, 12, 14) # Infeasible if it goes through the 4 and 8 it has at least one element which makes it impossible to go through 9 without goint through 10
        #m < 0 
        #
    #    self.assertEqual(1, 1)
